  ...
  async generateContent(prompt, style = 'casual', maxRetries = 3, userToken = null, userId = null) {
    ...
    for (const provider of providers) {
      try {
        ...
        // Convert markdown bold syntax to Unicode bold
        const convertedResult = convertMarkdownToUnicode(result);
        // Enforce 3,000 character limit strictly
        const trimmedResult = convertedResult && convertedResult.length > 3000 ? convertedResult.slice(0, 2997) + '...' : convertedResult;

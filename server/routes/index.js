...
import twitterStatusRoutes from './twitterStatus.js';
import threadsStatusRoutes from './threadsStatus.js';
...
router.use('/twitter', twitterStatusRoutes);
router.use('/threads', threadsStatusRoutes);
